...
<head>
	...
	<!--central WSU CSS from template designer-->
	...
	<script>
	  ...
	  ga('create', 'UA-6322839-3', 'wsu.edu');
	  ga('send', 'pageview');
...
<body <?php body_class(); ?>>
	...
	<!--End of the WSU Identifier Zone. -->
		...
		<!-- Optional Javascript navtool insert location. Visit http://identity.wsu.edu/web/downloads/add-ons/nav-java.aspx for more info -->
			<div id="featured">
				<ul>
					<li><a href="http://news.wsu.edu">WSU News</a></li>
					<li><a href="http://announcements.wsu.edu">WSU Announcements</a></li>
				</ul>
			</div>
		    <!-- Main Navigation -->
